export const SEARCH_LENGTH_LIMIT = 1; // minimum number of characters required for search queries
...
export const NUM_FETCH_MOVIES = 50; // number of movies to fetch from given search query 